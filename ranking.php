...
<body>
    <div id="menu">
        ...
        <style>
            ...
            div#all{
    background: url("img/ranking.jpeg");
    ...
    <div id='all'>
        ...
        <div id="log_reg_container">
            ...
            <a href="ranking_liceum.php">
                    <div id="register_container">
                        <h3>Liceum </h3>
                    </div>
                </a>
<br><br>
            <a href="ranking_technikum.php">
                    <div id="register_container">
                        <h3>Technikum </h3>
                    </div>
                </a>
