...
<div id="all">
    ...
    <div id="a-wszystko">
    <div id="a-opcja">
    <h3>LO nr III im. Adama Mickiewicza</h3>
    <br>Wrocław<hr>
    </div>
    
    <div id="a-opcja">
    <h3>Technikum Mechatroniczne nr 1 w ZSLiT nr 1</h3>
    <br>Warszawa<hr>
    </div>
    
    <div id="a-opcja">
    <h3>Technikum w Zespole Szkół Ekonomicznych</h3>
    <br>Mińsk Maz.<hr>
    </div>
    
    <div id="a-opcja">
    <h3>Tech. Geol.-Geod.-Drog. im. St. Kluźniaka</h3>
    <br>Warszawa<hr>
    </div>
    </div>
